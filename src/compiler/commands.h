...
inline constexpr CmdInfo kCommands[] = {
  ...
  { "AmbientLight",        "",  "r#,g#,b#" },
  { "AnimateMD2",          "",  "md2%,mode%?,speed#?,first%?,last%?,trans#?" },
  { "AntiAlias",           "",  "arg1%" },
  ...
  { "CreateBrush",         "%", "r#?,g#?,b#?" },
  { "CreateCamera",        "%", "parent%?" },
  { "CreateCone",          "%", "segs%?,solid%?,parent%?" },
  { "CreateCube",          "%", "parent%?" },
  { "CreateCylinder",      "%", "segs%?,solid%?,parent%?" },
  { "CreateDir",           "",  "path$" },
  ...
  { "TFormedY",            "#", "" },
  { "TFormedZ",            "#", "" },
  { "TFormNormal",         "",  "x#,y#,z#,src%,dest%" },
  { "TFormPoint",          "",  "x#,y#,z#,src%,dest%" },
  { "TFormVector",         "",  "x#,y#,z#,src%,dest%" },
