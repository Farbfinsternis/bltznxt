...
| **Known deviations** | 19 open bugs that can break an old program, all reproduced against Blitz3D 11.8; accepted differences listed separately ([KNOWN_ISSUES.md](KNOWN_ISSUES.md)) |
